...
public:
    void update()
    {
        ...
        cout << "Notificatiion sent to android user " << this << endl;
    }
};
...
public:
    ...
    {
        //! Logic to update Subscriber, may be through email
        cout << "Notifiction send to iphone user: " << this << endl;
    }
};
...
int main()
{
    ...
    SubscriberTypeA yousaf, shaheer;
    SubscriberTypeB moeez;

    publisher.registerSubscriber(&yousaf);
